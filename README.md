...
- 📦 [**Portfolio**](https://github.com/vpodhornyi/portfolio): Modern Portfolio built with **Next.js 16**, **Tailwind CSS v4**, and **Framer Motion**. Features a professional **i18n** setup, Dockerized for production, and deployed on a **VPS** via an automated **GitHub Actions CI/CD** pipeline.
